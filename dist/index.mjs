...
import { AlertTriangle, XCircle, Info, CheckCircle2, Mic, Minus, Plus, ChevronDown, Check, Baseline, RefreshCw } from 'lucide-react';
...
function Editor({
  ...
  const prevMediaRef = useRef(/* @__PURE__ */ new Set());
  const deleteTimers = useRef(/* @__PURE__ */ new Map());
  ...
  const startVoiceTyping = useCallback((langOverride) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `bn-wrapper w-full max-w-4xl mx-auto transition-all duration-300 ease-in-out ${editable ? "min-h-[400px] pb-32" : "min-h-0 pb-0"}`, style: { position: "relative" }, children: [
    isListening && /* @__PURE__ */ jsxs(
      "div",
      {
        style: {
          position: "sticky",
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", { style: { color: "white", fontFamily: "Inter, system-ui, sans-serif", fontWeight: 600, fontSize: "14px", letterSpacing: "0.5px" }, children: "Listening..." }),
          /* @__PURE__ */ jsx(
            "select",
            {
              value: voiceLang,
              ...
              children: voiceLanguages.map((lang) => /* @__PURE__ */ jsx("option", { value: lang.code, style: { color: "#333", background: "white" }, children: lang.label }, lang.code))
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
    ...
    showSlug && editable && /* @__PURE__ */ jsxs("div", { style: { padding: "0 16px", marginBottom: "8px" }, children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
