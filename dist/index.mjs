...
import { createReactBlockSpec, createReactStyleSpec, useCreateBlockNote, SuggestionMenuController, getDefaultReactSlashMenuItems, FormattingToolbarController, useSelectedBlocks, FormattingToolbar, FileCaptionButton, FileReplaceButton, FileRenameButton, FileDownloadButton, FileDeleteButton, FilePreviewButton, TextAlignButton, BlockTypeSelect, blockTypeSelectItems, BasicTextStyleButton, ColorStyleButton, NestBlockButton, CreateLinkButton } from '@blocknote/react';
...
import { fetchViaProxy, AIExtension, ClientSideTransport, AIMenuController, getAISlashMenuItems, AIToolbarButton } from '@blocknote/xl-ai';
import { en } from '@blocknote/xl-ai/locales';
import { createOpenAICompatible } from '@ai-sdk/openai-compatible';
import { useRef, useState, useMemo, useEffect } from 'react';
import { AlertTriangle, XCircle, Info, CheckCircle2, ChevronDown, Check, Baseline } from 'lucide-react';
import { Menu, Group, Tooltip, TextInput, Text, ActionIcon, Divider } from '@mantine/core';
...
function Editor({
  ...
  const FontSizeSelect = () => {
    ...
    return /* @__PURE__ */ jsx(Group, { gap: 0, className: "mx-1", children: /* @__PURE__ */ jsxs(Menu, { shadow: "xl", width: 180, position: "bottom", withArrow: true, transitionProps: { transition: "pop-top-left" }, children: [
      /* @__PURE__ */ jsx(Menu.Target, { children: /* @__PURE__ */ jsx(Tooltip, { label: "Font Size", withArrow: true, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center px-2 py-1 mx-1 rounded hover:bg-slate-100 cursor-pointer border border-slate-200 transition-colors bg-white", children: [
        /* @__PURE__ */ jsx(
          TextInput,
          {
            variant: "unstyled",
        ...
        /* @__PURE__ */ jsx(ChevronDown, { size: 10, className: "opacity-40 ml-1" })
      ] }) }) }),
      /* @__PURE__ */ jsx(Menu.Dropdown, { className: "bg-white border-slate-200 p-1 shadow-[0_20px_50px_rgba(0,0,0,0.2)]", children: sizes.map((size) => /* @__PURE__ */ jsx(
        Menu.Item,
        {
  ...
  const FontFamilySelect = () => {
    ...
    return /* @__PURE__ */ jsxs(Menu, { shadow: "xl", width: 240, position: "bottom-start", withArrow: true, transitionProps: { transition: "pop-top-left" }, children: [
      ...
      /* @__PURE__ */ jsx(Menu.Dropdown, { className: "bg-white border-slate-200 max-h-[400px] overflow-y-auto p-1 shadow-[0_20px_50px_rgba(0,0,0,0.2)]", children: groups.map((group) => /* @__PURE__ */ jsxs("div", { children: [
  ...
  const CustomFormattingToolbar = () => {
    ...
    return /* @__PURE__ */ jsx(FormattingToolbar, { children: isMedia ? /* @__PURE__ */ jsxs(Fragment$1, { children: [
      ...
      aiConfig?.apiKey && /* @__PURE__ */ jsx(AIToolbarButton, {}),
      /* @__PURE__ */ jsx(
        BlockTypeSelect,
        {
          items: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: editable ? "min-h-[400px] pb-20" : "min-h-0 pb-0", children: [
    showSlug && editable && /* @__PURE__ */ jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsx(
      "input",
      {
        type: "text",
