...
var mantine = require('@blocknote/mantine');
require('@blocknote/mantine/style.css');
require('@blocknote/xl-ai/style.css');
var react = require('@blocknote/react');
var extensions = require('@blocknote/core/extensions');
var locales$1 = require('@blocknote/core/locales');
var core = require('@blocknote/core');
var codeBlock = require('@blocknote/code-block');
var xlAi = require('@blocknote/xl-ai');
var locales = require('@blocknote/xl-ai/locales');
...
var Alert = react.createReactBlockSpec(
  {
    type: "alert",
    propSchema: {
      textAlignment: core.defaultProps.textAlignment,
      textColor: core.defaultProps.textColor,
      type: {
        default: "warning",
  ...
  },
  {
    render: (props) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "alert flex flex-row items-center w-full min-h-[48px] px-3 py-2 rounded-lg my-2 gap-4", "data-alert-type": props.block.props.type, style: { backgroundColor: alertType.backgroundColor.light }, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(core$1.Menu, { withinPortal: false, zIndex: 999999, disabled: !props.editor.isEditable, children: [
          /* @__PURE__ */ jsxRuntime.jsx(core$1.Menu.Target, { children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: `alert-icon-wrapper p-1 rounded-sm ${props.editor.isEditable ? "cursor-pointer hover:bg-black/5" : ""}`, contentEditable: false, children: /* @__PURE__ */ jsxRuntime.jsx(
            Icon,
            {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(core$1.Menu.Dropdown, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(core$1.Menu.Label, { children: "Alert Type" }),
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "inline-content flex-1 max-w-full", ref: props.contentRef })
      ] });
    }
  }
);
...
function Editor({
  ...
  const [isListening, setIsListening] = react$1.useState(false);
  const [voiceLang, setVoiceLang] = react$1.useState("en-US");
  const voiceLangRef = react$1.useRef("en-US");
  const recognitionRef = react$1.useRef(null);
  const voiceLanguages = react$1.useMemo(() => [
    { code: "en-US", label: "\u{1F1FA}\u{1F1F8} English" },
    { code: "bn-BD", label: "\u{1F1E7}\u{1F1E9} \u09AC\u09BE\u0982\u09B2\u09BE" },
    { code: "hi-IN", label: "\u{1F1EE}\u{1F1F3} \u0939\u093F\u0928\u094D\u0926\u0940" },
    { code: "ar-SA", label: "\u{1F1F8}\u{1F1E6} \u0627\u0644\u0639\u0631\u0628\u064A\u0629" },
    { code: "es-ES", label: "\u{1F1EA}\u{1F1F8} Espa\xF1ol" },
    { code: "fr-FR", label: "\u{1F1EB}\u{1F1F7} Fran\xE7ais" },
    { code: "de-DE", label: "\u{1F1E9}\u{1F1EA} Deutsch" },
    { code: "pt-BR", label: "\u{1F1E7}\u{1F1F7} Portugu\xEAs" },
    { code: "ru-RU", label: "\u{1F1F7}\u{1F1FA} \u0420\u0443\u0441\u0441\u043A\u0438\u0439" },
    { code: "zh-CN", label: "\u{1F1E8}\u{1F1F3} \u4E2D\u6587" },
    { code: "ja-JP", label: "\u{1F1EF}\u{1F1F5} \u65E5\u672C\u8A9E" },
    { code: "ko-KR", label: "\u{1F1F0}\u{1F1F7} \uD55C\uAD6D\uC5B4" },
    { code: "tr-TR", label: "\u{1F1F9}\u{1F1F7} T\xFCrk\xE7e" },
    { code: "ur-PK", label: "\u{1F1F5}\u{1F1F0} \u0627\u0631\u062F\u0648" },
    { code: "it-IT", label: "\u{1F1EE}\u{1F1F9} Italiano" },
    { code: "nl-NL", label: "\u{1F1F3}\u{1F1F1} Nederlands" },
    { code: "pl-PL", label: "\u{1F1F5}\u{1F1F1} Polski" },
    { code: "sv-SE", label: "\u{1F1F8}\u{1F1EA} Svenska" },
    { code: "th-TH", label: "\u{1F1F9}\u{1F1ED} \u0E44\u0E17\u0E22" },
    { code: "vi-VN", label: "\u{1F1FB}\u{1F1F3} Ti\u1EBFng Vi\u1EC7t" },
    { code: "ms-MY", label: "\u{1F1F2}\u{1F1FE} Bahasa Melayu" },
    { code: "id-ID", label: "\u{1F1EE}\u{1F1E9} Bahasa Indonesia" },
    { code: "ta-IN", label: "\u{1F1EE}\u{1F1F3} \u0BA4\u0BAE\u0BBF\u0BB4\u0BCD" },
    { code: "te-IN", label: "\u{1F1EE}\u{1F1F3} \u0C24\u0C46\u0C32\u0C41\u0C17\u0C41" },
    { code: "fil-PH", label: "\u{1F1F5}\u{1F1ED} Filipino" },
    { code: "uk-UA", label: "\u{1F1FA}\u{1F1E6} \u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430" },
    { code: "el-GR", label: "\u{1F1EC}\u{1F1F7} \u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC" },
    { code: "he-IL", label: "\u{1F1EE}\u{1F1F1} \u05E2\u05D1\u05E8\u05D9\u05EA" },
    { code: "fa-IR", label: "\u{1F1EE}\u{1F1F7} \u0641\u0627\u0631\u0633\u06CC" },
    { code: "sw-KE", label: "\u{1F1F0}\u{1F1EA} Kiswahili" }
  ], []);
  ...
  const schema = react$1.useMemo(() => {
    const base2 = core.BlockNoteSchema.create({
      styleSpecs: {
        ...core.defaultStyleSpecs,
        fontSize: react.createReactStyleSpec(
          {
            type: "fontSize",
            propSchema: "string"
          },
        ...
        fontFamily: react.createReactStyleSpec(
          {
            type: "fontFamily",
            propSchema: "string"
          },
  ...
  const safeInitialBlocks = react$1.useMemo(() => {
  ...
  if (aiConfig && (aiConfig.apiKey || aiConfig.proxyUrl)) {
    ...
    if (aiConfig.proxyUrl) {
      customFetch = xlAi.fetchViaProxy((url) => `${aiConfig.proxyUrl}?url=${encodeURIComponent(url)}`);
    } else if (isLongCat) {
      customFetch = createLongCatFetch();
    }
    extensions$1.push(
      xlAi.AIExtension({
        transport: new xlAi.ClientSideTransport({
          model: openaiCompatible.createOpenAICompatible({
            name: "custom-ai",
  ...
  const editor = react.useCreateBlockNote({
    dictionary: {
      ...locales$1.en,
      ai: locales.en
    },
  ...
  const startVoiceTyping = react$1.useCallback((langOverride) => {
  ...
  const stopVoiceTyping = react$1.useCallback(() => {
    if (recognitionRef.current) {
      recognitionRef.current.stop();
      recognitionRef.current = null;
      setIsListening(false);
  ...
  const voiceTypingItem = react$1.useMemo(() => ({
    title: "Voice Typing",
    onItemClick: () => {
      startVoiceTyping();
    },
    ...
    group: "Media",
    icon: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Mic, { size: 18 }),
  ...
  const generateSlugFromTitle = () => {
    if (title) {
      const generated = title.toLowerCase().replace(/[^\w\s-]+/g, "").replace(/\s+/g, "-").replace(/-+/g, "-").replace(/^-+|-+$/g, "");
      setSlug(generated);
      if (onSlugChange) {
  ...
  const FontFamilySelect = react$1.useCallback(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(core$1.Menu, { shadow: "xl", width: 240, position: "bottom-start", withArrow: true, transitionProps: { transition: "pop-top-left" }, children: [
      /* @__PURE__ */ jsxRuntime.jsx(core$1.Menu.Target, { children: /* @__PURE__ */ jsxRuntime.jsx(core$1.Tooltip, { label: "Font Family", withArrow: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
        core$1.ActionIcon,
        {
          variant: "subtle",
          color: "gray",
      ...
      /* @__PURE__ */ jsxRuntime.jsx(core$1.Menu.Dropdown, { className: "bg-white/95 backdrop-blur-md border-slate-200/60 max-h-[400px] overflow-y-auto p-1.5 rounded-xl shadow-xl shadow-slate-200/40", children: groups.map((group) => /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        ...
        families.filter((f) => f.group === group).map((family) => /* @__PURE__ */ jsxRuntime.jsx(
          core$1.Menu.Item,
          {
            ...
            rightSection: activeFamily === family.value && /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Check, { size: 12, className: "text-emerald-600" }),
            children: /* @__PURE__ */ jsxRuntime.jsx(core$1.Text, { size: "sm", style: { fontFamily: family.value }, children: family.label })
          },
          family.value
        )),
  ...
  const CustomFormattingToolbar = react$1.useCallback(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(react.FormattingToolbar, { children: isMedia ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(react.FileCaptionButton, {}, "fileCaptionButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.FileReplaceButton, {}, "fileReplaceButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.FileRenameButton, {}, "fileRenameButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.FileDownloadButton, {}, "fileDownloadButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.FileDeleteButton, {}, "fileDeleteButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.FilePreviewButton, {}, "filePreviewButton"),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-px h-6 bg-slate-200 mx-1 self-center" }),
      /* @__PURE__ */ jsxRuntime.jsx(react.TextAlignButton, { textAlignment: "left" }, "textAlignLeftButton"),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          items: [
            ...react.blockTypeSelectItems(editor.dictionary),
            {
              name: "Alert",
              type: "alert",
              icon: lucideReact.AlertTriangle
      ...
      /* @__PURE__ */ jsxRuntime.jsx(react.BasicTextStyleButton, { basicTextStyle: "bold" }, "boldStyleButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.BasicTextStyleButton, { basicTextStyle: "italic" }, "italicStyleButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.BasicTextStyleButton, { basicTextStyle: "underline" }, "underlineStyleButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.BasicTextStyleButton, { basicTextStyle: "strike" }, "strikeStyleButton"),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-px h-6 bg-slate-200 mx-1 self-center" }),
      /* @__PURE__ */ jsxRuntime.jsx(FontSizeSelect, {}),
      /* @__PURE__ */ jsxRuntime.jsx(FontFamilySelect, {}),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-px h-6 bg-slate-200 mx-1 self-center" }),
      /* @__PURE__ */ jsxRuntime.jsx(react.ColorStyleButton, {}, "colorStyleButton"),
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-px h-6 bg-slate-200 mx-1 self-center" }),
      /* @__PURE__ */ jsxRuntime.jsx(react.TextAlignButton, { textAlignment: "left" }, "textAlignLeftButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.TextAlignButton, { textAlignment: "center" }, "textAlignCenterButton"),
      /* @__PURE__ */ jsxRuntime.jsx(react.TextAlignButton, { textAlignment: "right" }, "textAlignRightButton"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `bn-wrapper w-full max-w-4xl mx-auto transition-all duration-300 ease-in-out ${editable ? "min-h-[400px] pb-32" : "min-h-0 pb-0"}`, style: { position: "relative" }, children: [
    isListening && /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        style: {
          position: "sticky",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { color: "white", fontFamily: "Inter, system-ui, sans-serif", fontWeight: 600, fontSize: "14px", letterSpacing: "0.5px" }, children: "Listening..." }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "select",
            {
              value: voiceLang,
              ...
              children: voiceLanguages.map((lang) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: lang.code, style: { color: "#333", background: "white" }, children: lang.label }, lang.code))
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
    ...
    showSlug && editable && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: "0 16px", marginBottom: "8px" }, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px", marginBottom: "16px" }, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      mantine.BlockNoteView,
      {
        ...
        slashMenu: false,
        children: [
          aiConfig?.apiKey && /* @__PURE__ */ jsxRuntime.jsx(xlAi.AIMenuController, {}),
          editable && /* @__PURE__ */ jsxRuntime.jsx(
            react.SuggestionMenuController,
            {
              triggerCharacter: "/",
              getItems: async (query) => extensions.filterSuggestionItems(
                [
                  ...react.getDefaultReactSlashMenuItems(editor),
                  ...aiConfig?.apiKey ? xlAi.getAISlashMenuItems(editor) : [],
                  voiceTypingItem
                ],
                query
              )
          ...
          editable && /* @__PURE__ */ jsxRuntime.jsx(react.FormattingToolbarController, { formattingToolbar: CustomFormattingToolbar })
        ]
      }
    )
  ] });
